          ...
          children: [
            ...
            Card(
              child: ListTile(
                ...
                subtitle: const Text('Mr. John Doe, SIC : 1234567890', overflow: TextOverflow.ellipsis,),
                ...
                SizedBox(
                  ...
                  child: Card(
                    child: ListTile(
                      leading: IconButton.filledTonal(
                        onPressed: () {},
                          icon: Icon(Icons.event_available, color: Theme.of(context).colorScheme.primary,)
                      ),
                      title: const Text('Start Date', overflow: TextOverflow.ellipsis,),
                ...
                SizedBox(
                  ...
                  child: Card(
                    child: ListTile(
                      leading: IconButton.filledTonal(
                        onPressed: () {},
                          icon: Icon(Icons.task_alt, color: Theme.of(context).colorScheme.primary,)
                      ),
                      title: const Text('Start Time', overflow: TextOverflow.ellipsis,),
                ...
                SizedBox(
                  ...
                  child: Card(
                    child: ListTile(
                      leading: IconButton.filledTonal(
                        onPressed: () {},
                          icon: Icon(Icons.event_busy, color: Theme.of(context).colorScheme.primary,)
                      ),
                      title: const Text('End Date', overflow: TextOverflow.ellipsis,),
                      subtitle: const Text('01/01/2021'),
                      titleTextStyle: titleStyle,
                    ),
                  ),
                ...
                SizedBox(
                  ...
                  child: Card(
                    child: ListTile(
                      ...
                      title: const Text('End Time', overflow: TextOverflow.ellipsis,),
                      subtitle: const Text('10:00 AM'),
                      titleTextStyle: titleStyle,
                    ),
                  ),
